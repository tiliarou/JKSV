...
namespace data
{
    ...
    class icn
    {
        public:
            ...
            void draw(unsigned x, unsigned y) { texDrawNoAlpha(iconTex, frameBuffer, x, y, false); }
            void drawHalf(unsigned x, unsigned y) { texDrawSkipNoAlpha(iconTex, frameBuffer, x, y, false); }
