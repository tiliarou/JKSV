...
namespace ui
{
    ...
    void updateAdvMode(const uint64_t& down, const uint64_t& held, const touchPosition& p)
    {
        ...
        drawText(saveWrap.c_str(), frameBuffer, ui::shared, 16, 668, 14, mnuTxt, false);
        drawText(sdWrap.c_str(), frameBuffer, ui::shared, 656, 668, 14, mnuTxt, false);
        ...
        if(advMenuCtrl == 2)
        {
            ...
            {
                case 0:
                    drawText("SAVE", frameBuffer, ui::shared, 472, 250, 18, txtClr, false);
                    break;

                case 1:
                    drawText("SDMC", frameBuffer, ui::shared, 472, 250, 18, txtClr, false);
                    break;
            }
